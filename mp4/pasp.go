...
func (b *PaspBox) Size() uint64 { _ = "STUB: not implemented"; return 0 }

// Encode - write box to w
func (b *PaspBox) Encode(w io.Writer) error { _ = "STUB: not implemented"; return nil }

// EncodeSW - box-specific encode to slicewriter
func (b *PaspBox) EncodeSW(sw bits.SliceWriter) error { _ = "STUB: not implemented"; return nil }
